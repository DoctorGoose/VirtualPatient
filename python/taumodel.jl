...
function LCTModel!(du, u, p, t, state_history::StateHistory)
    ...
    # Unpack parameters
    beta, k, p_param, c, delta, xi, a, d_E, delta_E, K_delta_E, zeta, eta, K_I1, tau_memory, tau_effector = p

    # Retrieve delayed state
    CD8_E_tau = interpolate_delay(state_history, 5, t - tau_memory)  # 5th state (CD8_E)
    I2_tau = interpolate_delay(state_history, 3, t - tau_effector) # 2nd state (I1)
    ...
    du[5] = xi * I2_tau  - d_E * CD8_E  # Effector T Cells 
